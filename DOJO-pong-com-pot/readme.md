...
1. [Primeiro desafio] Alterar o código em `potenciometros.pyde` de círculos para jogadores retangulares que se movem na vertical;
2. [Desafio Final] Transferir o código de leitura dos potenciômetros para o código em `pong-sem-potenciometros.pyde`.
